...
process_flat_table('product_contents', 'product_contents.csv', ['product_id', 'description_html', 'highlights_html', 'specs_html'])
...
process_flat_table('reviews', 'reviews.csv', ['user_id', 'product_id', 'parent_review_id', 'rating', 'comment_text', 'review_date'])
