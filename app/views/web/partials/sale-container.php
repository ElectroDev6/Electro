...
<div class="container-main">
    <section class="sale category-product remove-padding">
        <div class="sale__header">
            <h2 class="sale__title">HOT SALE

                <svg width="35px" height="35px" viewBox="-33 0 255 255" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid" fill="#000000">
            ...
            <div class="sale__countdown-container">
                <div class="sale__countdown">
                    <?php if (!empty($saleProducts) && $saleStatus === 'today'): ?>
                        <div class="sale__timer"><span class="text-end">Kết thúc trong:</span> <span class="sale__time" data-end="<?= $saleProducts[0]['end_date'] ?>"></span></div>
