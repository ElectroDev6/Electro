                ...
                <ul class="header__top-nav">
                    <li class="header__top-item">
                        <span class="header__top-icon">
                            <svg width="14" height="14" xmlns="http://www.w3.org/2000/svg" fill="#333e48" viewBox="-1.12 0 15.999 15.999">
                                <path d="M6.882 16a1.48 1.48 0 0 1-1.048-.433l-3.818-3.818A6.837 6.837 0 0 1 0 6.882a6.833 6.833 0 0 1 2.016-4.865A6.837 6.837 0 0 1 6.882 0a6.837 6.837 0 0 1 4.866 2.016 6.833 6.833 0 0 1 2.016 4.865 6.837 6.837 0 0 1-2.016 4.867L7.93 15.566A1.48 1.48 0 0 1 6.882 16Zm0-15a5.843 5.843 0 0 0-4.159 1.723 5.889 5.889 0 0 0 0 8.318l3.818 3.818a.485.485 0 0 0 .682 0l3.818-3.818a5.889 5.889 0 0 0 0-8.318A5.843 5.843 0 0 0 6.882 1Zm0 9.159a3.281 3.281 0 0 1-3.277-3.277A3.281 3.281 0 0 1 6.882 3.6a3.281 3.281 0 0 1 3.277 3.282 3.281 3.281 0 0 1-3.277 3.277Zm0-5.559a2.28 2.28 0 0 0-2.277 2.278 2.28 2.28 0 0 0 2.277 2.281 2.28 2.28 0 0 0 2.277-2.277A2.28 2.28 0 0 0 6.882 4.6Z" data-name="Path 74" />
                            </svg>
                        </span>
                    ...
                    <li class="header__top-item">
                        <span class="header__top-icon">
                            <svg width="20" height="20" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" stroke-width="3" stroke="#333e48" fill="none">
