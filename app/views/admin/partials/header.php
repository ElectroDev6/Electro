        ...
        <div class="header__actions">
            <div class="header__notifications">
                <button class="header__notification-btn">
                    <svg width="20" height="20" fill="none" class="header__notification-icon" viewBox="0 0 24 24">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 8A6 6 0 1 0 6 8c0 7-3 9-3 9h18s-3-2-3-9ZM13.73 21a2 2 0 0 1-3.46 0" />
                    </svg>
                ...
                <button class="header__notification-btn">
                    <svg width="20" height="20" fill="none" class="header__notification-icon" viewBox="0 0 24 24">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v10Z" />
                    </svg>
