            ...
            <nav class="sidebar__nav">
                <ul class="sidebar__menu">
                    <li class="sidebar__menu-item">
                        <a href="/admin/dashboard" class="sidebar__menu-link sidebar__menu-item--active">
                    ...
                    <li class="sidebar__menu-item">
                        <a href="/admin/products" class="sidebar__menu-link">
                            <svg class="sidebar__menu-icon" width="16" height="16" viewBox="0 0 24 24" fill="none">
                                <path d="M7 4V2C7 1.46957 7.21071 0.960859 7.58579 0.585786C7.96086 0.210714 8.46957 0 9 0H15C15.5304 0 16.0391 0.210714 16.4142 0.585786C16.7893 0.960859 17 1.46957 17 2V4H20C20.5304 4 21.0391 4.21071 21.4142 4.58579C21.7893 4.96086 22 5.46957 22 6C22 6.53043 21.7893 7.03914 21.4142 7.41421C21.0391 7.78929 20.5304 8 20 8H19V19C19 19.5304 18.7893 20.0391 18.4142 20.4142C18.0391 20.7893 17.5304 21 17 21H7C6.46957 21 5.96086 20.7893 5.58579 20.4142C5.21071 20.0391 5 19.5304 5 19V8H4C3.46957 8 2.96086 7.78929 2.58579 7.41421C2.21071 7.03914 2 6.53043 2 6C2 5.46957 2.21071 4.96086 2.58579 4.58579C2.96086 4.21071 3.46957 4 4 4H7Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                    ...
                    <li class="sidebar__menu-item">
                        <a href="/admin/comments" class="sidebar__menu-link">
                            <svg class="sidebar__menu-icon" width="16" height="16" viewBox="0 0 24 24" fill="none">
