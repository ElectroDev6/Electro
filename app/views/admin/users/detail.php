        ...
        <div class="user-detail">
            ...
            <section class="user-detail__profile">
                ...
                <div class="user-detail__profile-info">
                    ...
                    <p class="user-detail__email"><?php echo htmlspecialchars($user['email'] ?? 'Không có email'); ?>
                    </p>
                    <div class="user-detail__badges">
                        <span
                            class="user-detail__badge user-detail__badge--<?php echo ($user['is_active'] ? 'active' : 'inactive'); ?>">
                            <?php echo ($user['is_active'] ? 'Đang hoạt động' : 'Không hoạt động'); ?>
                        </span>
                        <span
                            class="user-detail__badge user-detail__badge--<?php echo ($user['role'] === 'admin' ? 'admin' : 'customer'); ?>">
                ...
                <section class="user-detail__section">
                    ...
                    <div class="user-detail__info-grid">
                        <div class="user-detail__info-item">
                            ...
                            <span
                                class="user-detail__value"><?php echo htmlspecialchars($user['email'] ?? 'Không có email'); ?></span>
                        </div>
                        <div class="user-detail__info-item">
                            <label class="user-detail__label">Phone:</label>
                            <span
                                class="user-detail__value"><?php echo htmlspecialchars($user['phone_number'] ?? 'Không có số điện thoại'); ?></span>
                        </div>
                        <div class="user-detail__info-item">
                            <label class="user-detail__label">Gender:</label>
                            <span
                                class="user-detail__value"><?php echo htmlspecialchars($user['gender'] ?? 'Không xác định'); ?></span>
                        </div>
                        <div class="user-detail__info-item">
                            <label class="user-detail__label">Birth Date:</label>
                            <span
                                class="user-detail__value"><?php echo htmlspecialchars($user['birth_date'] ?? 'Không có ngày sinh'); ?></span>
                        </div>
                    </div>
                </section>
            ...
            <section class="user-detail__section">
                ...
                <div class="user-detail__info-grid">
                    <div class="user-detail__info-item">
                        ...
                        <span
                            class="user-detail__value"><?php echo htmlspecialchars($user['name'] ?? 'Không có tên'); ?></span>
                    </div>
                    <div class="user-detail__info-item">
                        <label class="user-detail__label">Vai trò:</label>
                        <span
                            class="user-detail__value"><?php echo htmlspecialchars($user['role'] ?? 'Không xác định'); ?></span>
                    </div>
                    <div class="user-detail__info-item">
                    ...
                    <div class="user-detail__info-item">
                        ...
                        <span
                            class="user-detail__value"><?php echo htmlspecialchars($user['created_at'] ?? 'Không có ngày'); ?></span>
                    </div>
                    <div class="user-detail__info-item">
                        <label class="user-detail__label">Cập nhật lần cuối:</label>
                        <span
                            class="user-detail__value"><?php echo htmlspecialchars($user['updated_at'] ?? 'Không có ngày'); ?></span>
                    </div>
                </div>
            </section>
        </div>
